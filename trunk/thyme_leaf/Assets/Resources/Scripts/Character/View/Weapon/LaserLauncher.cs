...
public class LaserLauncher : Weapon, ILauncher
{
    ...
    private string animName = "Laser_";
    ...
    void Update()
    {
		if (!doesAttack && sprite.spriteName == "Laser_2")
        {
    ...
    private void Initialize()
    {
		...
		this.sprite.spriteName = "Laser_0";
    ...
    */
     ...
     */
    public new const string TAG = "[LaserLauncher]";
}
