...
public class ATT_Type1Controller
{
    private ATT_Type1 view;
    private Tower model;

    public ATT_Type1Controller(ATT_Type1 view, Tower model)
    {
        this.view = view;
        this.model = model;
    }
...
public class ATT_Type1 : GameEntity, IATT_Type1, IStateMachineControllable<ATT_Type1>, IObserver, IView
{
    ...
    private StateMachine<ATT_Type1> stateMachine;

    //---------------------MVC
    [SerializeField]
    private Tower model;
    private ATT_Type1Controller controller;
    ...
    */
    ...
    void Initialize()
    {
        ...
        this.controller = new ATT_Type1Controller(this, model);

        //State machine
        this.stateMachine = new StateMachine<ATT_Type1>(this);
    ...
    */
    public void ChangeState(State<ATT_Type1> newState)
    {
    ...
    */
    ...
    public StateMachine<ATT_Type1> StateMachine
    {
        get { return stateMachine; }
    }
    ...
    public ATT_Type1Controller Controller
    {
